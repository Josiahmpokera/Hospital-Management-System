...
?>
    ...
    <div class="row">
       ...
       <div class="card" style="padding: 16px; margin-top: 16px;">
        ...
        <div class="card-body">
           <p>UTRASOUND-USS PELVIC</p>
           <?php
           

                $sqlRequired = $conn->query("SELECT * FROM radiologyTest WHERE patient_id = '$patient_id' || DATE(dateCreated) = CURDATE() ");
                $fetchsql = $sqlRequired->fetch_array();
                $radiologyTest = $fetchsql['radDia_id'];


                $sqlRadiologyDiagnosis = $conn->query("SELECT * FROM raddiaCategories WHERE diaCat_id  ='$radiologyTest'");
                $fetchRadiologyDiagnosis = $sqlRadiologyDiagnosis->fetch_array();
                $testName = $fetchRadiologyDiagnosis['name'];
                echo $testName; 
           
           ?>
            <p>X-RAY- X-Ray(Chest)</p>
       ...
       <div class="card" style="padding: 16px; margin-top: 16px;">
        ...
        <div class="card-body">
           ...
           <p>UTRASOUND-USS PELVIC</p>
            ...
            <button type="button" class="btn btn-outline-dark btn-block" id="add_result_radiology" style="float: right;">Add Results</button>
        </div>
    </div>
...
<div class="modal" id="radiology_results_Modal" role="dialog">
...
<script type="text/javascript">
         ...
         var btn = document.getElementById("add_result_radiology");
         
         var modal = document.getElementById("radiology_results_Modal");
